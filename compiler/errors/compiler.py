...
def start():
    ...
    with open(f"{DEST}/all.py", "w", encoding="utf-8") as f_all:
        ...
        for i in files:
            ...
            with (open(f"{HOME}/source/{i}", encoding="utf-8") as f_csv, open(f"{DEST}/{name.lower()}_{code}.py", "w", encoding="utf-8") as f_class):
                ...
                with open(f"{HOME}/template/class.txt", "r", encoding="utf-8") as f_class_template:
                    class_template = f_class_template.read()

                    with open(f"{HOME}/template/sub_class.txt", "r", encoding="utf-8") as f_sub_class_template:
